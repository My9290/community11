...
import com.nowcoder.community1.community1.config.ThreadPoolConfig;
...
import com.nowcoder.community1.community1.service.ElasticsearchService;
...
public class EventConsumer implements CommunityConstant {
    ...
    public void handlePublishMessage(ConsumerRecord record){
        ...
        DiscussPost post = discussServicePost.findDiscussPostById(event.getEntityId());
        //将帖子数据存入es服务器中
...
//        System.out.println("sunny");
        ...
        System.out.println(suffix);
            ...
            Future fature = taskScheduler.scheduleAtFixedRate(task,500);
            task.setFuture(fature);
